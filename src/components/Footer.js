        ...
        <div className="col-lg-4 col-12 p-xl-5 py-4">
          <div className="row">
            ...
            <div className="col-lg-12 col-6">
              ...
              <p className="text-white m-0 footerText">Site design by <a className="footerLink" href="https://www.chloeford.co.uk/">Chloe Ford</a></p>
              <p className="text-white footerText">Built by <a className="footerLink" href="https://sophieheb.com">Sophie Hebdidge</a></p>
              <p className="text-white footerText">
                <a className="footerLink" href="/terms-and-conditions">Terms and Conditions</a>, <a className="footerLink" href="privacy-policy">Privacy Policy</a> & <a className="footerLink" href="cookie-policy">Cookie Policy</a> </p>
            </div>
          </div>
        </div>
      </div>
