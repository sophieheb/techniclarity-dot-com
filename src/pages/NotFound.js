...
function NotFound() {
  ...
  >
    ...
    >
      <h1><span>404</span> Whoops! This page doesn't exist.</h1>
      <p>You were probably looking for our <a href="/course">courses</a> or <a href="/tuition">tuition</a>. Or maybe you just want to head back to the <a href="/">homepage.</a></p>
    </div>
  </div>
  );
}
