    ...
    <div className="container-fluid p-5">
      <div className="row">
        <div className="col-lg-6 col-12 p-lg-5 py-5 px-3">
          ...
          <p className="mb-0">
          Is this the best programming language to use?</p>
          <p className="mb-0">
          What can I do to make sure my product is successful?</p>
          <p className="mb-0" >
        ...
        <div className="col-lg-6 col-12 p-lg-5 py-5 px-3">
          ...
          <p className="mb-3">
          You’ve done the work and the research, but you don’t have the professional eye to feel confidence in the output.          </p>
          <p className="mb-3">
          In one hour we’ll work through your idea, strategy, specification or roadmap. With an expert eye, I’ll validate your work and give you my professional opinion on places for improvement.          </p>
          ...
          <p className="mb-0">
          I've written a strategy, but I'm not sure I've thought of everything.</p>
          <p className="mb-0">
          I'm recruiting a CTO, is this job specification going to get me the best people applying?</p>
          <p className="mb-0">
          I've got this idea, is it possible?</p>
          <p className="mb-0">
          How do I know that this plan is right?</p>
          <p className="mb-0" >
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-12 py-3">
          ...
          <Collapse in={faqFourOpen}>
            ...
            <p>For masterclasses, I’ll send you over a selection of dates once you have downloaded the brochure. Normal availability is up to a month in advance.
        ...
        <div className="col-md-6 col-12 py-3">
          ...
          <Collapse in={faqFiveOpen}>
            <div>
              <p>Power hours and sanity checks can be changed up to 1 week before they are scheduled. Any changes in the week before we are booked in will incur a rescheduling fee.
              </p>
              <p>Masterclasses can be rearranged up to 2 weeks before they are scheduled. Any changes after that date will incur a rescheduling fee.
              </p>
            </div>
          </Collapse>
        </div>
