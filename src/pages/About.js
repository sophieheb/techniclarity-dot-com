...
<p>Technology is creating a new world; this gives us the chance to create a more equal society. However, when the majority of founders, people leading technological change and new ideas all come from one demographic, well that new world is going to be pretty geared towards that one group - and won’t be so equal.</p>
    ...
    <div className="container-fluid p-5 bg-cyan">
      ...
      <h3 className="text-white text-center m-auto w-lg-50 w-xs-100 pb-5 d-lg-block d-none">Women with ideas that could change the world are <span>completely stalled.</span></h3>
      <h3 className="text-white m-auto w-lg-50 w-xs-100 pb-4  d-lg-none d-block">As a result</h3>
      <h1 className="text-white  m-auto w-lg-50 w-xs-100 pb-5  d-lg-none d-block">Women with ideas that could change the world are <span>completely stalled.</span></h1>
    </div>

    <div className="container-fluid bg-green p-5">
      <h3 className="w-lg-50 w-xs-100 m-auto text-white text-lg-center p-lg-5">Techniclarity was started to create <span>long term change </span> - to equip women with what they needed for the future, not just for now. Which is why Techniclarity is <span>all about education </span>because as you grow, so does your business. 
</h3>
    </div>
    ...
    >
      ...
      <div className="col-lg-6 col-12 h-100 d-flex justify-content-center">
        <img
          src={headshot}
